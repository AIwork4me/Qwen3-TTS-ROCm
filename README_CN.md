...
| vLLM-Omni 服务 | — | 🟡 部分验证 —— 当前栈离线路径已证（2026-09-24：vllm 0.30.0+rocm723 + vllm-omni 0.30.0rc1，逐字使用上游 end2end.py）：全部三个 1.7B 任务族 CustomVoice / VoiceDesign / Base 克隆均产出有限非静音 24 kHz 音频；隔离 venv，暂不做服务/流式/性能声明 | [`vllm-omni-current-gfx1151-2026-09-24.txt`](evidence/vllm-omni-current-gfx1151-2026-09-24.txt) · [JSON](evidence/vllm-omni-current-gfx1151-2026-09-24.json) · 旧 0.28.0 快照：[`vllm-omni-feasibility-2026-09-21.txt`](evidence/vllm-omni-feasibility-2026-09-21.txt) |
